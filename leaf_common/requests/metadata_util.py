...
class MetadataUtil():
    ...
    @classmethod
    def to_tuples(cls, metadata: Union[Dict[str, Any], List[Any], Tuple[Any, ...]]) -> Tuple[Tuple[Any, ...], ...]:
        """
    ...
    @classmethod
    def to_dict(cls, metadata: Union[Dict[str, Any], List[Any], Tuple[Any, ...]]) -> Dict[str, Any]:
        """
